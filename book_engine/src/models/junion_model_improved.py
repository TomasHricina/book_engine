...
# load ratings
ratings = pd.read_csv(book_ratings_path, encoding='cp1251', sep=';')
ratings = ratings[ratings['Book-Rating']!=0]

# load books
books = pd.read_csv(books_path
,  encoding='cp1251', sep=';',error_bad_lines=False)

# Load original books dataset
books = pd.read_csv(books_path
,encoding='cp1251'
,sep=';'
,usecols = [_isbn, _title, _authors]
# ,dtype={_isbn: 'string'}
...
print(books_of_tolkien_readers)
...
with pd.option_context('display.max_rows', None,
    ...
    # print(number_of_rating_per_book)
    pass

#select only books which have actually higher number of ratings than threshold
books_to_compare = number_of_rating_per_book['Book-Title'][number_of_rating_per_book['User-ID'] >= 20]
